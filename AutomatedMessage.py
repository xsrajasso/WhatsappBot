...
def obtener_matriculas_con_faltas(archivo, hoja, umbral_faltas=2):
    ...
    # Definir variable matrículas
    matriculas = []
    
    # Condiciones basadas en el día de la semana
...
print("Que grupo quieres busacar? (Ex. 1°A)")
# hoja = "1°A"
hoja = input()
...
for m in matriculas:
    ...
    if __name__ == "__main__":
        ...
        # hoja = input()
        print(f"Se esta buscando la matricula ({m}) en el Directorio")
        # valor = int(input())
        valor = m
        print("Buscando...")
